...
def callClient(cla_id, cla_token):
...
def addUttSuccess(client, match, utterance):
    pairObj = []
    myDict = {}
...
def main():
    ...
    client = callClient(cla_id, cla_token)
    ...
    while True:
        ...
        if int(case) == 2:
            ...
            while not addUttSuccess(client, match, utterance):
